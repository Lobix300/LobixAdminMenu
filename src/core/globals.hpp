...
namespace big
{
	...
	public:
		...
		struct tunables
		{
			...
			bool enable_snow = false;

			NLOHMANN_DEFINE_TYPE_INTRUSIVE(tunables, disable_phone, no_idle_kick, enable_snow)
		} tunables{};
		...
		struct self 
		{
			...
			NLOHMANN_DEFINE_TYPE_INTRUSIVE(self,
				...
				noclip, off_radar, super_run, no_collision, unlimited_oxygen, no_water_collision, wanted_level, invincible_mode,
		...
		struct session
		{
			...
			bool semi_invinciblemode_all = false;
		...
		struct spoofing
		{
			...
			bool spoof_hide_invincible = true;
			...
			NLOHMANN_DEFINE_TYPE_INTRUSIVE(spoofing,
				...
				spoof_cheater, spoof_hide_invincible, spoof_hide_spectate, spoof_rockstar_dev, spoof_rockstar_qa, spoof_crew_data,
		...
		struct vehicle
		{
			...
			NLOHMANN_DEFINE_TYPE_INTRUSIVE(vehicle,
				speedo_meter, fly, rainbow_paint, speed_unit, invincible_mode,
		...
		struct esp
		{
			...
			NLOHMANN_DEFINE_TYPE_INTRUSIVE(esp,
				...
				box, health, armor, invincible, distance, name, change_esp_color_from_dist, scale_health_from_dist, scale_armor_from_dist,
