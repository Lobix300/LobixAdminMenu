...
namespace big
{
	...
	void renderer::end_frame()
	{
		...
		/*big::renderer shit;
		for (auto& function : shit.m_present_callbacks)
		{
			shit.m_restoreState = shit.m_stateSaver->saveCurrentState(shit.m_d3d_device_context);
			function(shit.m_dxgi_swapchain);
			if (shit.m_restoreState)
				shit.m_stateSaver->restoreSavedState();
		}*/
	}
}
